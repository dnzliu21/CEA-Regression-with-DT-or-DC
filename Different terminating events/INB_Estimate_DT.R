GetEstimateResult=readRDS("/home/dnliu21/Code/DTcode/Results/Results_ICER_Est_Light_N400_nsim2000_logn_xxxx_xx_xx.RDS")
...
true.INB.M.XF.Z0=WTP15*true.beta.TFL[3]-true.beta.M[3]/1000
true.INB.M.XF.Z1=WTP15*(true.beta.TFL[3]+true.beta.TFL[4])-(true.beta.M[3]/1000+true.beta.M[4]/1000)
...
CovSW_INB_MXF_Z0=matrix(unlist(EstimateResult$ICER_SW_MandXF_Cov_Z0),nsim,1,byrow=TRUE)
CovSW_INB_MXF_Z1=matrix(unlist(EstimateResult$ICER_SW_MandXF_Cov_Z1),nsim,1,byrow=TRUE)
CovSWIMP_INB_MXF_Z0=matrix(unlist(EstimateResult$ICER_SWIMP_MandXF_Cov_Z0),nsim,1,byrow=TRUE)
CovSWIMP_INB_MXF_Z1=matrix(unlist(EstimateResult$ICER_SWIMP_MandXF_Cov_Z1),nsim,1,byrow=TRUE)
...
GetResult <- function(estDiff_Eff_Z,estDiff_M_Z,true.INB.Z,nsim,WTP,Syy_Eff_Z,Sxx_M_Z,Cov_INB_Z,z_alpha) {
  ...
  # CP
  CP_INB_Z=mean(cover_INB_Z_nsim,na.rm=TRUE)
...
ResSW_MXF_Z0=GetResult(estDiff_SW_XF_Z0,estDiff_SW_M_Z0,true.INB.M.XF.Z0,nsim,WTP15,Syy_SW_XF_Z0,Sxx_SW_M_Z0,CovSW_INB_MXF_Z0,z_alpha)
ResSWIMP_MXF_Z0=GetResult(estDiff_SW_XF_Z0,estDiff_IMP_M_Z0,true.INB.M.XF.Z0,nsim,WTP15,Syy_SW_XF_Z0,Sxx_IMP_M_Z0,CovSWIMP_INB_MXF_Z0,z_alpha)

ResSW_MXF_Z1=GetResult(estDiff_SW_XF_Z1,estDiff_SW_M_Z1,true.INB.M.XF.Z1,nsim,WTP15,Syy_SW_XF_Z1,Sxx_SW_M_Z1,CovSW_INB_MXF_Z1,z_alpha)
ResSWIMP_MXF_Z1=GetResult(estDiff_SW_XF_Z1,estDiff_IMP_M_Z1,true.INB.M.XF.Z1,nsim,WTP15,Syy_SW_XF_Z1,Sxx_IMP_M_Z1,CovSWIMP_INB_MXF_Z1,z_alpha)
...
results15 = data.frame(
  ...
  round(t(cbind(ResSW_MXF_Z0$mean_INB_Z, ResSWIMP_MXF_Z0$mean_INB_Z, ResSW_MXF_Z1$mean_INB_Z, ResSWIMP_MXF_Z1$mean_INB_Z)),2),
  round(t(cbind(ResSW_MXF_Z0$bias_INB_Z, ResSWIMP_MXF_Z0$bias_INB_Z, ResSW_MXF_Z1$bias_INB_Z, ResSWIMP_MXF_Z1$bias_INB_Z)),2),
  round(t(cbind(ResSW_MXF_Z0$SSE_INB_Z, ResSWIMP_MXF_Z0$SSE_INB_Z, ResSW_MXF_Z1$SSE_INB_Z, ResSWIMP_MXF_Z1$SSE_INB_Z)),2),
  round(t(cbind(ResSW_MXF_Z0$ESE_INB_Z, ResSWIMP_MXF_Z0$ESE_INB_Z, ResSW_MXF_Z1$ESE_INB_Z, ResSWIMP_MXF_Z1$ESE_INB_Z)),2),
  round(t(cbind(ResSW_MXF_Z0$CP_INB_Z, ResSWIMP_MXF_Z0$CP_INB_Z, ResSW_MXF_Z1$CP_INB_Z, ResSWIMP_MXF_Z1$CP_INB_Z)),3)
  )


colnames(results15)=c("Variable","WTP","Method","Subgroup",
                    "EMean INB M&Q","Bias M&Q","SSE M&Q","ESE M&Q","CP M&Q",
                    "EMean INB M&XF","Bias M&XF","SSE M&XF","ESE M&XF","CP M&XF")




WTP3=3
true.INB.M.Q.Z0=WTP3*true.beta.Q[3]-true.beta.M[3]/1000
true.INB.M.Q.Z1=WTP3*(true.beta.Q[3]+true.beta.Q[4])-(true.beta.M[3]/1000+true.beta.M[4]/1000)
true.INB.M.XF.Z0=WTP3*true.beta.TFL[3]-true.beta.M[3]/1000
true.INB.M.XF.Z1=WTP3*(true.beta.TFL[3]+true.beta.TFL[4])-(true.beta.M[3]/1000+true.beta.M[4]/1000)


ResSW_MQ_Z0=GetResult(estDiff_SW_Q_Z0,estDiff_SW_M_Z0,true.INB.M.Q.Z0,nsim,WTP3,Syy_SW_Q_Z0,Sxx_SW_M_Z0,CovSW_INB_MQ_Z0,z_alpha)
ResIMP_MQ_Z0=GetResult(estDiff_IMP_Q_Z0,estDiff_IMP_M_Z0,true.INB.M.Q.Z0,nsim,WTP3,Syy_IMP_Q_Z0,Sxx_IMP_M_Z0,CovIMP_INB_MQ_Z0,z_alpha)

ResSW_MQ_Z1=GetResult(estDiff_SW_Q_Z1,estDiff_SW_M_Z1,true.INB.M.Q.Z1,nsim,WTP3,Syy_SW_Q_Z1,Sxx_SW_M_Z1,CovSW_INB_MQ_Z1,z_alpha)
ResIMP_MQ_Z1=GetResult(estDiff_IMP_Q_Z1,estDiff_IMP_M_Z1,true.INB.M.Q.Z1,nsim,WTP3,Syy_IMP_Q_Z1,Sxx_IMP_M_Z1,CovIMP_INB_MQ_Z1,z_alpha)

ResSW_MXF_Z0=GetResult(estDiff_SW_XF_Z0,estDiff_SW_M_Z0,true.INB.M.XF.Z0,nsim,WTP3,Syy_SW_XF_Z0,Sxx_SW_M_Z0,CovSW_INB_MXF_Z0,z_alpha)
ResSWIMP_MXF_Z0=GetResult(estDiff_SW_XF_Z0,estDiff_IMP_M_Z0,true.INB.M.XF.Z0,nsim,WTP3,Syy_SW_XF_Z0,Sxx_IMP_M_Z0,CovSWIMP_INB_MXF_Z0,z_alpha)

ResSW_MXF_Z1=GetResult(estDiff_SW_XF_Z1,estDiff_SW_M_Z1,true.INB.M.XF.Z1,nsim,WTP3,Syy_SW_XF_Z1,Sxx_SW_M_Z1,CovSW_INB_MXF_Z1,z_alpha)
ResSWIMP_MXF_Z1=GetResult(estDiff_SW_XF_Z1,estDiff_IMP_M_Z1,true.INB.M.XF.Z1,nsim,WTP3,Syy_SW_XF_Z1,Sxx_IMP_M_Z1,CovSWIMP_INB_MXF_Z1,z_alpha)
